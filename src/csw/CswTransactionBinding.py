...
'''
import requests
from settings import gn_settings
from src.utils.Utils import fileToString
from src.csw.TransactionRequests import transaction_delete_identifier, build_transaction_insertRequest
